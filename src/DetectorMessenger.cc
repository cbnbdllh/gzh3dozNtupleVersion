...
:G4UImessenger(),fDetector(Det)
{
  ...
  fScintillatorMatPropVectorCmd->SetGuidance("the box.");
  ...
  fScintillatorMatPropConstCmd->SetGuidance("for the box.");
  ...
  fScintillatorMaterialCmd = new G4UIcmdWithAString("/opnovice2/boxMaterial", this);
  fScintillatorMaterialCmd->SetGuidance("Set material of box.");
...
{    
  ...
  // TYPE
    ...
    fDetector->AddScintillatorMPV(c, mpv);
  }
    ...
    const char* c = prop.c_str();
    fDetector->AddScintillatorMPC(c, val);
  }
